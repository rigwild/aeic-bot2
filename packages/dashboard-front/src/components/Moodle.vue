    ...
    <form @submit.prevent="getCalendar" class="mt-4">
      ...
      <fieldset :disabled="loading">
        ...
        <div class="form-check">
          <input v-model="form.saveCredentials" class="form-check-input" type="checkbox" id="saveCredentialsMoodle">
          <label class="form-check-label" for="saveCredentialsMoodle">
    ...
    <Promised :promise="promise" class="mt-2">
      ...
      <template v-slot="data">
        <div class="iframe-container">
          <iframe :srcdoc="data" sandbox="allow-popups allow-popups-to-escape-sandbox"></iframe>
        </div>
      </template>
